...
def upgrade() -> None:
    ...
    op.create_table('country_adjacencies',
    ...
    sa.Column('team_assignment', sa.String(length=20), nullable=False, server_default="'MANUAL'"),
    ...
    sa.ForeignKeyConstraint(['tertiary_country_code'], ['countries.code'], ondelete='RESTRICT'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_index('ix_competitions_creator_id', 'competitions', ['creator_id'], unique=False)
    op.create_index('ix_competitions_status', 'competitions', ['status'], unique=False)
    op.create_index('ix_competitions_start_date', 'competitions', ['start_date'], unique=False)
    op.create_index('ix_enrollments_competition_id', 'enrollments', ['competition_id'], unique=False)
    ...
    op.create_unique_constraint('uq_enrollment_competition_user', 'enrollments', ['competition_id', 'user_id'])
