    ...
    def test_valid_response(self):
        dto = ScoringViewResponseDTO(
            ...
            round_info=RoundInfoDTO(
                id="r1", date="2026-03-01", session_type="MORNING", golf_course_name="Club"
            ),
            competition_id="c1",
            team_a_name="Team A",
            team_b_name="Team B",
            ...
            match_standing=MatchStandingDTO(
                status="AS", leading_team=None, holes_played=0, holes_remaining=18
            ),
    ...
    def test_valid_response(self):
        dto = SubmitScorecardResponseDTO(
            ...
            result=ScorecardResultDTO(
                winner="A", score="3&2", team_a_points=1.0, team_b_points=0.0
            ),
