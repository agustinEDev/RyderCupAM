...
competitions_table = Table(
    ...
    Column('creator_id', UserIdDecorator, ForeignKey('users.id', ondelete='CASCADE'), nullable=False),
...
enrollments_table = Table(
    ...
    Column('competition_id', CompetitionIdDecorator, ForeignKey('competitions.id', ondelete='CASCADE'), nullable=False),
    ...
    if Competition not in mapper_registry.mappers:
        mapper_registry.map_imperatively(
            ...
            properties={
                ...
                'name': composite(
                    lambda n: CompetitionName(n) if n else None,
                    '_name_value'
                ),
