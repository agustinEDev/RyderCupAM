...
class RegisterUserRequestDTO(BaseModel):
    ...
    first_name: str = Field(
        ..., min_length=2, max_length=FieldLimits.NAME_MAX_LENGTH, description="Nombre del usuario."
    )
    last_name: str = Field(
        ...,
        min_length=2,
...
class LoginRequestDTO(BaseModel):
    ...
    password: str = Field(
        ..., max_length=FieldLimits.PASSWORD_MAX_LENGTH, description="Contraseña del usuario."
    )
...
class UpdateProfileResponseDTO(BaseModel):
    ...
    message: str = Field(
        default="Perfil actualizado exitosamente", description=CONFIRMATION_MESSAGE_DESCRIPTION
    )
...
class UpdateSecurityResponseDTO(BaseModel):
    ...
    user: UserResponseDTO = Field(..., description="Información actualizada del usuario.")
    message: str = Field(
        default="Datos de seguridad actualizados", description=CONFIRMATION_MESSAGE_DESCRIPTION
    )
...
class VerifyEmailResponseDTO(BaseModel):
    ...
    message: str = Field(
        default="Email verificado exitosamente", description=CONFIRMATION_MESSAGE_DESCRIPTION
    )
    email_verified: bool = Field(
